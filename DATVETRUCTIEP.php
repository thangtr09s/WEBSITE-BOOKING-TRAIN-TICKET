                ...
                <div class="row">
                  <div class="col-lg-7">
                      <div class="main_title">
                        <h2>Đăng Kí Online</h2>
                      </div>
                    <div class="billing_form_area">
                      <form class="billing_form row" method="post" action="DATVETRUCTIEP.php" id="contactForm" novalidate="novalidate">
                ...
                <div class="col-lg-7">
                      <div class="main_title">
                        <h2>Thông Tin Chuyến Đi</h2>
                                ...
                                <div class="form-group col-md-12">
                    <label for="time">Thời Gian Đi *</label>
                  <input type="time" class="form-control" id="thoigian" name="thoigian" placeholder="Thời Gian">
                </div>
                <div class="form-group col-md-12">
  ...
  <option>Tuyến số 1: Bến xe Trung tâm Đà Nẵng - Bến xe Hội An</option> 
    ...
    <option>Tuyến số 11: Hoàng Sa - bãi xe Trường Sa</option></select> </td>
                ...
                <div class="form-group col-md-12">
                  ...
                  <textarea class="form-control" name="ghichu" id="message" rows="1" placeholder="Ghi Chú Của Bạn ( Nếu Không Có Ghi Chú Thì Gõ None )"></textarea><br>
                  <button type="submit" value="datve" name="datvebus" class="btn pest_btn">Đặt vé</button>
                                 <?php require 'xulydatve.php';?>
                        ...
                        <div class="order_box_price">
                            ...
                            <div class="payment_list">
                                <div class="price_single_cost">
                                    ...
                                    <h5>Vé xe Bus x 1 <span>15.000đ</span></h5>
                                    <h5>Hành Lí<span class="text_f">5.000đ</span></h5>
                                    <h3>Tổng Cộng <span>20.000đ</span></h3>
                                </div>
                                <div id="accordion" class="accordion_area">
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <h5 class="mb-0">
                                                ...
                                                <input type="checkbox" name="" class="btn btn-link">
                                        <label><h6><b>Chuyển tiền trực tiếp qua ngân hàng</b></h6></label>
                                                </button>
                                            </h5>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingTwo">
                                            <h5 class="mb-0"><br>
                                                <input type="radio" name="nganhang" value="Đã Thanh Toán Bàng Agribank"> <label><h6>Agribank</h6></label><br>
                                                <input type="radio" name="nganhang" value="Đã Thanh Toán Bàng Vietcombank"> <label><h6>Vietcombank</h6></label>
                                            </h5>
                                        </div>
